...
async function userMovedVoice(oldVoiceState, newVoiceState) {
    if (oldVoiceState.member.user.id == client.user.id) {
        console.log(`User moved me to new channel. Attempting to leave ${oldVoiceState.channelID}`);
        return leaveChannelById(oldVoiceState.channelID);
    }
