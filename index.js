...
/**
 * Remove the user referenced by the voiceState from the GuildNormal, and cleanup if channel is now empty
...
/**
 * Stops receiving voice, and calculates stores average volume of each all voice chunks
 * @param {GuildNormal} guildNormal - The guildNormal the speaker is a part of.
 * @param {User} user - The user who started speaking.
 */
